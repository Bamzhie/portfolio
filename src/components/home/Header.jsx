...
const Header = () => {
  ...
  return (
    <div
      id="home"
      className=" home-hero bg-center text-white  dark:bg-black dark:text-white"
    >
      <div>
              ...
              <div className="">
                <div className="pb-4">
                  <motion.h1
                    ...
                    initial="hidden"
                    animate="visible"
                    className="text-start xs:text-center heading-primary"
                  >
                    SHEU AHMAD{" "}
                  </motion.h1>
                </div>
                ...
                {showElement ? (
                  <div>
                    ...
                    <Link
                      to="#projects"
                      className="xs:hidden xxl:inline"
                      smooth
                    >
                      <motion.a
                        className="btn btn--bg  bg-green-800 text-white"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
